  ...
  <body>
 	<div class="container">
 		...
 		<div class="page-header">
			...
			<a class="btn btn-success active" href="http://localhost/trab-formularios(boostrap)/Index.html">Atras</a>	
		</div>
 		<div class="row">
			<div class="col-md-4">	
			...
			<div class="col-md-2">
				...
				<button type="button" class="btn btn-success btn-agregar-producto active">Agregar</button>
				</div>
			</div>
		</div>
