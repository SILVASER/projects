$(document).ready(function () {
       ...
       $('#cerrar').click(function () {
            $('.navegacion .menu').css({'left': '-320px'}); /*mostrar el menú*/
    ...
    $('.navegacion .menu > .item-submenu a').click(function () {
        ...
        $('.item-submenu_2[menu=' + positionMenu + '] .submenu_2').css({'left': '0px'}); /*mostramos el submenu correspondiente*/
    ...
    $('.navegacion .submenu_2 li.regresar').click(function () {
